...
class EzxmlToDocbookTest extends BaseTest
{
    ...
    {
        return __DIR__ . '/../../../../../../src/lib/eZ/RichText/Resources/stylesheets/ezxml/docbook/docbook.xsl';
    }
    ...
    protected function getCustomConversionTransformationStylesheets()
    {
        return [
            [
                'path' => __DIR__ . '/../../../../../../src/lib/eZ/RichText/Resources/stylesheets/ezxml/docbook/core.xsl',
                'priority' => 99,
            ],
            [
